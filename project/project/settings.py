...
SECRET_KEY = 'django-insecure-)$t!()^9@pr$96$=wti4%c8p*k_@6zunuj7msfw2lo6fillapu'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'medical',  # Apka MySQL database ka naam
        'USER': 'root',  # MySQL username (default: root)
        'PASSWORD': 'root',  # MySQL ka password
        'HOST': '127.0.0.1',  # Agar local hai to localhost, nahi to IP likhein
